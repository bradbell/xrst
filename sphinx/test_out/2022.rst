...
3. The :ref:`indent` did not work properly in files that contained
   :ref:`comment_ch_cmd`. This has been fixed.
4. The comment command was added; see :ref:`comment_example`.
5. Add an error message when :ref:`comment_ch_cmd` is present but not
