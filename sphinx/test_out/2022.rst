...
08-21
*****
Change the command names  listed below (see :ref:`toc_cmd`).
This was done because these commands act like the sphinx toctree command.
...
1. Fix documentation for relative location of :ref:`file_cmd@display_file`
   in file command and :ref:`toc_cmd@file_names` in toc commands.
