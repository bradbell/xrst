...
def auto_file(
    ...
    file_data += '\n\n'
    file_data += '.. toctree::\n'
    file_data += 4 * ' ' + ':maxdepth: 1\n'
    file_data += '\n'
    if target == 'html' :
        file_data += 4 * ' ' + 'xrst_search\n'
        file_data += 4 * ' ' + 'xrst_index\n'
    file_data += 4 * ' ' + 'xrst_contents\n'
    for page_name in root_page_list :
        file_data += 4 * ' ' + '' + page_name + '\n'
    #
    # xrst_root_doc.rst
