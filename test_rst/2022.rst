...
11-30
=====
1. Create a :ref:`toml_file@directory` table in the toml configuration file
   and put the *project_directory* , *rst_directory* ,
   *html_directory* , and *pdf_directory* setting there.
2. Change the *toml_path* command line argument to *toml_file* because
   it no longer specifies the *project_directory* .
3. Change the *output_dir* command line argument to the choice of
