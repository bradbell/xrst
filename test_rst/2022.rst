...
#. Bring :ref:`get_started-name` up to date with current xrst.
   To be specific, :ref:`user_guide@Install Stable Version`,
...
#. Create the first
   :ref:`stable install <user_guide@Install Stable Version>` .
...
2. Create the first
   :ref:`pip install <user_guide@Install Stable Version>` of xrst.
