...
#. Add some common verbs to the
   configure file :ref:`toml_file@not_in_index` Example

.. _2022@mm-dd@11-30:

11-30
=====
#. Create a :ref:`toml_file@directory` table in the toml configuration file
   and put the *project_directory* , *rst_directory* ,
   *html_directory* , and *pdf_directory* setting there.
#. Change the *toml_path* command line argument to *toml_file* because
   it no longer specifies the *project_directory* .
#. Change the *output_dir* command line argument to the choice of
   :ref:`toml_file@directory@html_directory` and
   :ref:`toml_file@directory@pdf_directory` in the toml configuration file.
#. Fix path resolution so that :ref:`toml_file@directory@rst_directory`
   may contain ``../`` ; i.e., it need not be a sub-directory
   of the project directory.
#. If :ref:`run_xrst@target` is ``pdf`` , run latex twice to properly
   resolve cross references.
#. Change the :ref:`toml file directories <toml_file@directory>`
...
This problem started on 11-23 when the toml file
:ref:`toml_file@preamble` split up the latex macros and the substitutions.
...
:ref:`toml_file@directory@html_directory` and
:ref:`toml_file@directory@pdf_directory`.
...
11-23
=====
1. The :ref:`toml_file@preamble` table was changed to
...
3. Add the :ref:`toml_file@html_theme_options` table was added,
...
11-22
=====
The :ref:`toml_file-name` was changed to be a sequence of tables.
...
2. Use ``xrst.toml`` as the default value for :ref:`run_xrst@toml_file` .
...
1. Change the root_file command line argument to *toml_path*
   on :ref:`2022@mm-dd@11-30` it was changed to :ref:`run_xrst@toml_file` .
2. Add :ref:`toml_file@project_name` and :ref:`toml_file@root_file`
   to the toml file.
3. Use the notation :ref:`toml_file@directory@project_directory`
...
2. The wish list configuration item was completed using
   ...
   #. The output_dir command line argument was replaced by
      output_directory in the ``toml_file`` file.
   #. The sphinx_dir command line argument was replaced by
      :ref:`toml_file@directory@rst_directory` in the ``toml_file`` file.
   #. The preamble.rst file was replaced by the
      :ref:`toml_file@preamble` section of the ``toml_file`` file.
   #. The spelling file was replaced by the
      :ref:`toml_file@project_dictionary` section of the ``toml_file`` file.
   #. The keyword file was replaced by the
      :ref:`toml_file@not_in_index` section of the ``toml_file`` file.
