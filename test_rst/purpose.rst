...
#. Words in each heading are automatically included in the
   ...
   see :ref:`conf_file@not_in_index` .
...
#. Includes a spell checker with special words at two levels;
   ...
   and :ref:`conf_file@project_dictionary` at the project level.
...
#. The configuration file :ref:`conf_file@html_theme_options` allows for
