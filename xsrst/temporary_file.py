...
#
# line_increment:
# is an int version of the line_increment arguemnt to the xsrst program.
#
# pseudo_heading:
...
#
# file_in:
# is the name of the xsrst input file for this section.
#
# tmp_dir
...
#
# data_in
# is the data for this seciton with all the xsrst commands coverted to
# their sphinx RST values, except the {xsrst_section_number} command.
